...
class State {
	...
	constructor(pos, state) {
		...
		this.winner = this._won(pos-1, this.board[pos - 1].length - 1);
	 ...
	 * 
	 * @param {integer} col Column of the last move, 0 <= col < width
	 * @param {integer} row Row of the last move, 0 <= row < height
